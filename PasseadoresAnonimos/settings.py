...
SECRET_KEY = 'django-insecure-l=b0rs&ac-nyq@%_t5+&)4g@8d6pj)rp-zrfqy(nbnxl0sekh-'
...
ROOT_URLCONF = 'PasseadoresAnonimos.urls'
...
WSGI_APPLICATION = 'PasseadoresAnonimos.wsgi.application'
